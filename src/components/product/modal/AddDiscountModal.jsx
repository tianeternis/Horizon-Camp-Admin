import { createNewDiscountForProduct } from "@/services/discountService";
...
const FORM_NAME = "add-discount-form";
...
const AddDiscountModal = ({
  ...
  const onFinish = async (values) => {
    ...
    if (startDate && endDate && productID) {
      ...
      const res = await createNewDiscountForProduct({
        productID,
        ...
        {conflict && (
          <div className="flex items-center gap-2 rounded-md border border-solid border-red-200 bg-red-50 p-2">
            ...
            <span className="text-justify">
              Không thể thực hiện thêm mới bởi vì đã có chiết khấu đang hoặc chờ
